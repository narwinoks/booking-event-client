...
import { getEventTicket } from "../Redux/actions/eventAction";
import Loadings from "react-loading";
const OrderDetailPage = () => {
  ...
  // get event ticket
  useEffect(() => {
    dispatch(getEventTicket(cart.ticket_id));
  }, [user, dispatch]);
          ...
          {Loading ? (
            <>
              <div className="flex justify-center items-center h-64">
                <Loadings type="spin" color="#000" height={50} width={50} />
              </div>
            </>
          ) : (
            <>
                  ...
                  <div className="col-span-12 bg-white px-4 py-4 md:col-span-4">
                    ...
                    <div className="py-4">
                      <div>
                        ...
                        <span className="font-normal">
                          {cart.order} Ticket {cart.order} Pax
                        </span>
                      </div>
                    </div>
                    <hr className="mb-4" />
                    <div className="py-4">
                      <p className="mb-2 text-sm font-light">Date Selected</p>
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="text-xl font-medium">
                        {parseFloat(event?.price * cart?.order).toLocaleString(
                          "id-ID"
                        )}
                      </p>
                    </div>
